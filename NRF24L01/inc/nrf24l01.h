 ...
 */
#define		WRITE_REG			0x20 /* Write data to register,instruction set format is 000AAAAA*/
...
#define		TX_MODE					0x00	/*< PRIM_RX bit clear i.e. Bit7=0>*/
#define		RX_MODE					0x01
#define		PWR_UP					0x02
#define		CRCO_16					0x04
#define		EN_CRC					0x08
 ...
 */
#define		RETR_PERIOD			0x20	 /*< Retries period 250+86us>*/
#define		RETR_MAX_NUM		0x0F	/*< The maximum number of retries is 15>*/
...
/*!\note Change value */
#define 	RF_CONFIG			0x27 /*< 0dbm gain,low noise amprifer,data rate 2Mbps>*/
...
extern uint8  idata tx_buf[PAYLOAD_BUF_LEN];
extern uint8  idata rx_buf[PAYLOAD_BUF_LEN];
extern uint8 const device_addr[PIPES_NUM][ADDR_WIDTH];
extern uint8 const edv_addr[3];
